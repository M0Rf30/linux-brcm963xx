...
int udelay_timeout_value=100;
#else
int udelay_timeout_value=1;
#endif
...
#if CONFIG_MTD_BRCMNAND_VERSION >= CONFIG_MTD_BRCMNAND_VERS_4_0 && !defined(CONFIG_BCM963148)
...
#if defined(CONFIG_BCM963148)
		chip->timing1 = 0x00240000;
		chip->timing2 = 0x00000005;
#endif
	}
#endif
...
#if CONFIG_MTD_BRCMNAND_VERSION >= CONFIG_MTD_BRCMNAND_VERS_7_0 && !defined(CONFIG_BCM963148)
